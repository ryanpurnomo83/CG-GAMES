 ...
 */ class Element {
   ...
   */ size(w, h) {
        if (arguments.length === 0) {
            ...
            let aW = w;
            let aH = h;
            const AUTO$1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$constants$2d$C$2d$g_eAdC$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"];
   ...
   */ style(prop, val) {
        const self = this;
        if (val instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$D4AAKRbx$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            val = val.toString();
        }
...
function media(p51, fn1) {
   ...
   * </code>
   * </div>
   */ fn1.createVideo = function(src, callback) {
   ...
   * </code>
   * </div>
   */ fn1.createAudio = function(src, callback) {
        // p5._validateParameters('createAudio', arguments);
        return createMedia(this, 'audio', src, callback);
    };
    /** CAMERA STUFF **/ fn1.VIDEO = 'video';
    fn1.AUDIO = 'audio';
   ...
   * </code>
   * </div>
   */ fn1.createCapture = function(...args) {
        ...
        for (const arg of args){
            if (arg === fn1.VIDEO) useAudio = false;
            else if (arg === fn1.AUDIO) useVideo = false;
...
//# sourceMappingURL=node_modules_p5_dist_dom_ac1319f1._.js.map